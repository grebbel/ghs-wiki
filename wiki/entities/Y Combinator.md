...
tags: [accelerator, venture-capital, silicon-valley, startup-school, ai-native-companies]
since: 2005
...
Promoted to a wiki entity page on 12 May 2026 after appearing as `author:` (channel) on two ingested videos in two consecutive days (Tan 23 April + Hu 24 April).

## Role in the wiki

YC is the **AI-native-startup-formation vantage** the wiki tracks across two distinct 2026-batch-contemporaneous sources:
...
### The YC-batch-context anchor pair

The two sources together form a **YC-batch-context anchor pair**: Hu prescribes the *framework*, Tan demonstrates the *worked example* at YC-president scale. Both align on the same diagnosis: AI-native companies need **fewer humans + queryable artifacts + software factories + a packaged harness of skills**. Same diagnosis from two distinct vantages (founder-CEO operator vs partner-observer-of-portfolio).
