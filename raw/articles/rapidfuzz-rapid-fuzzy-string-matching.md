...
converter: ''
notes: Acquired from Zotero collection `NBRA`. itemType `computerProgram` routed to raw/articles/ — confirm
...
It is MIT licensed so it can be used with whichever License you might want to choose for your project, while you're forced to adopt the GPL license when using FuzzyWuzzy
...
Deployed from af82c33

Englishespañolfrançais日本語português (Brasil)українськаΕλληνικάDeutsch中文 (简体)中文 (繁體)русскийעבריתEsperanto한국어
AWS
Datadog
Depot
Fastly
